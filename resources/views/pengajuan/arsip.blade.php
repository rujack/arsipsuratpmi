...
@section('container')
    <div class="row">
        <div class="col-12 bg-danger text-white p-3">
            <div class="row">
                <div class="col">
                    <h3 class="text-white text-uppercase">Pengajuan Surat Arsip</h3>
                </div>
            </div>
        </div>
            ...
            $('#myTable').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row) {
                        return '<span class="badge rounded-pill bg-danger">ARSIP</span>';
                    }
                }, {
                    targets: [6],
                    orderable: false,
